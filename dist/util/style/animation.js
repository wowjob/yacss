export const normalizeAnimation = (animation) => {
    ...
    if (typeof animation === 'object') {
        const { name = 'none', duration = 0, timingFunction = 'ease', delay = 0, iterationCount = 1, direction = 'normal', fillMode = 'none', playState = 'running', composition = 'replace', } = animation;
        return [
            name,
